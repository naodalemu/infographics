...
const SectionLabel = ({ children, gridRow }) => (
  <div className="sticky left-0 z-20 bg-gray-50 pr-4 flex items-center justify-end" style={{ gridRow }}>
    {children}
  </div>
);

const StageCard = ({ stage, gridRow }) => {
  const [isExpanded, setIsExpanded] = useState(true);
  return (
    <div className="border-l border-gray-200 px-6" style={{ gridRow }}>
      <div 
        className="flex items-center text-blue-800 font-semibold cursor-pointer"
...
const InputsCard = ({ stage, gridRow }) => {
    const [isExpanded, setIsExpanded] = useState(true);
    const hasInputs = stage.inputs && stage.inputs.length > 0;

    return (
        <div className="border-l border-gray-200 px-6 pt-4" style={{ gridRow }}>
            <div 
                className="flex items-center text-gray-700 font-semibold cursor-pointer"
                onClick={() => hasInputs && setIsExpanded(!isExpanded)}
            >
                {hasInputs && (isExpanded ? <ChevronUp size={20} className="mr-2"/> : <ChevronDown size={20} className="mr-2"/>)}
...
const ProductFormCard = ({ stage, gridRow, refs }) => (
  <div className="relative border-l border-gray-200 px-6 flex justify-center items-center" style={{ gridRow }}>
...
const LossesSection = ({ stage, gridRow, refs }) => (
  <div className="border-l border-gray-200 px-6 pt-4" style={{ gridRow }}>
        ...
        <div className="max-w-full mx-auto">
            ...
            <div className="overflow-x-auto pb-8">
                <div ref={containerRef} className="relative inline-grid gap-y-4" 
                    ...
                    <SectionLabel gridRow="1"><span className="font-semibold text-gray-500 text-sm">{data.sections.stage}</span></SectionLabel>
                    <SectionLabel gridRow="2"><span className="font-semibold text-gray-500 text-sm">{data.sections.inputs}</span></SectionLabel>
                    <SectionLabel gridRow="3"><span className="font-semibold text-gray-500 text-sm">{data.sections.productForm}</span></SectionLabel>
                    <SectionLabel gridRow="4"><span className="font-semibold text-gray-500 text-sm">{data.sections.losses}</span></SectionLabel>
